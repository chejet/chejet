...
{
    public partial class Photo : Admin
    {
        ...
        protected override void editBox()
        {
            ...
            doh.Reset();
            XkCms.DataOper.Data.WebFormHandler wh = new XkCms.DataOper.Data.WebFormHandler(doh, "Xk_Photo", btnSaveContent);
            ...
            wh.AddBind(hfDownUrl, "Value", "photourl", true);
