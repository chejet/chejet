...
namespace FredCK.FCKeditorV2
{
	...
	public class FCKeditor : System.Web.UI.Control, IPostBackDataHandler
	{
        ...
        public string ManagerPath
        {
            get
            {
                object o = ViewState["ManagerPath"];
                return (o == null ? "/Manager/" : (string)o);
            }
            set { ViewState["ManagerPath"] = value; }
        }
		...
		protected override void Render(HtmlTextWriter writer)
		{
			...
			if ( this.CheckBrowserCompatibility() )
			{
				...
				sLink += "editor/" + sFile + "?InstanceName=" + this.ClientID + "&amp;ManagerPath=" + ManagerPath ;
